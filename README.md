[Modding Tutorial](https://github.com/BlackteaGit/WaywardTerranFrontierModLoader/wiki/A-Quick-Introduction-To-DLL-Modding) | [Current Release Download](https://github.com/BlackteaGit/WaywardTerranFrontierModLoader/releases) | [Wiki](https://github.com/BlackteaGit/WaywardTerranFrontierModLoader/wiki)
...
**Legacy method:** (required by pre 0.9 game builds, required for WTFML builds v0.1/v0.2, will also work with any other WTFML builds and game versions )
